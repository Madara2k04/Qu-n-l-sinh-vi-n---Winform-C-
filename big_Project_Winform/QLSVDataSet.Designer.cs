...
namespace big_Project_Winform {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SinhVienRow AddSinhVienRow(string MaSV, string HoTen, System.DateTime NgaySinh, bool GioiTinh, string QueQuan, string MaLop) {
...
namespace big_Project_Winform.QLSVDataSetTableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SinhVien] WHERE (([MaSV] = @Original_MaSV) AND ([HoTen] = @Ori" +
                ...
                "ioiTinh) AND ([QueQuan] = @Original_QueQuan) AND ([MaLop] = @Original_MaLop))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SinhVien] ([MaSV], [HoTen], [NgaySinh], [GioiTinh], [QueQuan]," +
                " [MaLop]) VALUES (@MaSV, @HoTen, @NgaySinh, @GioiTinh, @QueQuan, @MaLop);\r\nSELEC" +
                "T MaSV, HoTen, NgaySinh, GioiTinh, QueQuan, MaLop FROM SinhVien WHERE (MaSV = @M" +
                "aSV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SinhVien] SET [MaSV] = @MaSV, [HoTen] = @HoTen, [NgaySinh] = @NgaySinh, [GioiTinh] = @GioiTinh, [QueQuan] = @QueQuan, [MaLop] = @MaLop WHERE (([MaSV] = @Original_MaSV) AND ([HoTen] = @Original_HoTen) AND ([NgaySinh] = @Original_NgaySinh) AND ([GioiTinh] = @Original_GioiTinh) AND ([QueQuan] = @Original_QueQuan) AND ([MaLop] = @Original_MaLop));
SELECT MaSV, HoTen, NgaySinh, GioiTinh, QueQuan, MaLop FROM SinhVien WHERE (MaSV = @MaSV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::big_Project_Winform.Properties.Settings.Default.QLSVConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSV, HoTen, NgaySinh, GioiTinh, QueQuan, MaLop FROM dbo.SinhVien";
        ...
        public virtual int Delete(string Original_MaSV, string Original_HoTen, System.DateTime Original_NgaySinh, bool Original_GioiTinh, string Original_QueQuan, string Original_MaLop) {
        ...
        public virtual int Insert(string MaSV, string HoTen, System.DateTime NgaySinh, bool GioiTinh, string QueQuan, string MaLop) {
            if ((MaSV == null)) {
        ...
        public virtual int Update(string MaSV, string HoTen, System.DateTime NgaySinh, bool GioiTinh, string QueQuan, string MaLop, string Original_MaSV, string Original_HoTen, System.DateTime Original_NgaySinh, bool Original_GioiTinh, string Original_QueQuan, string Original_MaLop) {
            if ((MaSV == null)) {
                throw new global::System.ArgumentNullException("MaSV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, System.DateTime NgaySinh, bool GioiTinh, string QueQuan, string MaLop, string Original_MaSV, string Original_HoTen, System.DateTime Original_NgaySinh, bool Original_GioiTinh, string Original_QueQuan, string Original_MaLop) {
            return this.Update(Original_MaSV, HoTen, NgaySinh, GioiTinh, QueQuan, MaLop, Original_MaSV, Original_HoTen, Original_NgaySinh, Original_GioiTinh, Original_QueQuan, Original_MaLop);
        }
    }
